...
class DrawUIElements:
    ...
    def draw_edge_green_boxes(self):
        ...
        # Bottom Left Corner
        bottom_left_rect = pygame.Rect(0, self.height - grass_bos_size, grass_bos_size, grass_bos_size)

        # Top Right center
        top_right_rect = pygame.Rect(self.width - grass_bos_size, 0, grass_bos_size, grass_bos_size)
    ...
    def draw_lanes(self):
        ...
        for i in range(1, 4):
            ...
            pygame.draw.rect(self.screen, ui_constants.UI_COLORS['GREY'], north_lane_line)

        # South Lanes
        for i in range(1, 4):
            left = grass_bos_size + i * lane_width_offset - line_width // 2

            south_lane_line = pygame.Rect(left, self.height - line_length, get_divider_length(i), line_length)
            pygame.draw.rect(self.screen, ui_constants.UI_COLORS['GREY'], south_lane_line)
        ...
        for i in range(1, 4):
            ...
            pygame.draw.rect(self.screen, ui_constants.UI_COLORS['GREY'], west_lane_line)

        # East Lanes
        for i in range(1, 4):
            top = grass_bos_size + i * lane_width_offset - line_width // 2

            east_lane_line = pygame.Rect(self.width - line_length, top, line_length, get_divider_length(i))
            pygame.draw.rect(self.screen, ui_constants.UI_COLORS['GREY'], east_lane_line)
    ...
    def draw_stop_lines(self):
        ...
        pygame.draw.line(self.screen, color, (center - stop_line_len, center - half_lane_dst),
        ...
        # West-bound
        pygame.draw.line(self.screen, color, (center - half_lane_dst, center - stop_line_len),
